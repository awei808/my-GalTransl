...
import type { PendingRestore } from "./reviewKeymap";

// 0.4.10 拆分：以下符号的实现已移至子模块，此处 re-export 维持既有引用面
// （5 个 vitest 文件从 ./ReviewPage 导入这些符号）。
export { EntryCard } from "./EntryCard";
export { applyProblemTypeFilter, toVisibleNewlines, ALL_FIELDS, EDITABLE_FIELD_KEYS } from "./reviewUtils";
export {
  isMetaKvEditorElement,
  shouldYieldToNative,
  shouldBlurBeforeUndo,
