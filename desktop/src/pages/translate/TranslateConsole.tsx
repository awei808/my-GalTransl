              ...
              <Match when={panelTab() === "flow"}>
                <div class="panel-content panel-content--scroll flow-view">
                  ...
                  <ol class="flow-list">
                    ...
                    <li><b>翻译后处理（改进/换行修复/语义检测）</b>：完整流水线翻译完成后，可按项目设置「翻译后处理后端」(gpt.afterTranslation) 逐文件追加改进轮（给出备选译文）、换行修复（修复异常换行）或语义差异检测（semcheck，用本地/外部AI标记疑似错译/漏译/串行）；也可直接选后端 ForImproveTranslation / ForBRStation / ForSemCheck 手动执行。</li>
