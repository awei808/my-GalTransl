...
const menus: MenuDef[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "", separator: true },
      { label: "文件内查找", shortcut: "Ctrl+F", action: () => document.dispatchEvent(new CustomEvent("galtransl:find-in-file")) },
      { label: "文件夹替换", shortcut: "Ctrl+H", action: () => setAppState({ sidebarOpen: true, sidebarTab: "find" }) },
      { label: "", separator: true },
