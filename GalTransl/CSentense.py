...
class CSentense:
    ...
    def __init__(self, pre_src: str = "", speaker: str = "", index: int = 0, **kwargs) -> None:
        ...
        self.tone_issue = ""  # AI 词语色彩检查标记（ForToneCheck 产出，非空即视为"词语色彩不一致"，由 find_problems 认领；ForToneCheckAgain 复核确认/撤销）
    ...
    @property
    def alt_dst(self) -> str:
        return self._alt_dst

    @alt_dst.setter
    def alt_dst(self, value: str) -> None:
        self._alt_dst = value
