...
internals:
  ...
  gendic:
    ...
    max_terms: 40          # 词数上限：terms 模式仅截断「片假名普通名词」（其余类别不限量一律收录）；llm 模式为词典总条数上限；0 不截断。[0-20000]
